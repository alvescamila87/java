...
public class Banco {
    ...
    public Banco() {
        Pessoa pessoa1 = new Pessoa("Princesa Isabel", "5816131616");
        Pessoa pessoa2 = new Pessoa("Dom Manoel", "651651651");

        Conta conta1 = new ContaInvestimento(pessoa1, 222, 999);
        Conta conta2 = new ContaInvestimento(pessoa2, 123, 888);
    ...
    // método que retorna Optional (objeto que funciona como container: que pode ou não ter algo):
